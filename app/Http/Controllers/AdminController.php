...
class AdminController extends Controller
{
    ...
    public function dashboard() {
        ...
        return view('admin.dashboard',['levels'=>Level::all(),'courses'=>Course::all()]);
    }

    public function getAllStudents($levelId) {

        return view('admin.class-students',['level'=>Level::find($levelId)]);
    }
