...
class AdminSectionController extends Controller
{
    ...
    public function setExamUpdate (Request $request, $levelCourseId)
    {
        $request->validate([
            'start'=>'required',
            'end'=>'required',
    ...
    public function configureExam() {
        ...
        return view('admin.exam.configure');
    }

    public function setExam($levelCourseId) {
        
        return view('admin.exam.set',['levelCourse'=>LevelCourse::find($levelCourseId)]);
    }
