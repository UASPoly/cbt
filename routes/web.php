...
Route::get('/hostexam', function() {
    return view('admin.host-exam',['subjects'=>Subject::all()]);
});
...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::group(['prefix' => 'admins', 'middleware' => ['auth:admins']], 
    function() {
        ...
        Route::get('/examination','Admin\AdminSectionController@configureExam')->middleware('can:superAdminGate')->name('exams');
        Route::get('/set/{levelCourseId}/exam','Admin\AdminSectionController@setExam')
        ->middleware('can:superAdminGate')->name('sets');
        Route::post('/set/{levelCourseId}/update','Admin\AdminSectionController@setExamUpdate')
        ->middleware('can:superAdminGate')->name('sets.update');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/level/{levelId}/students', 'AdminController@getAllStudents')->name('students');
    ...
    Route::get('/courses', 'Admin\AdminSectionController@teachersPage')->name('course');
    ...
    Route::post('/exam/{levelCourseId}/submit', 'ExamController@submit')->name('exam.submit');
    Route::get('/exam/{resultId}/result', 'ExamController@result')->name('exam.result');
